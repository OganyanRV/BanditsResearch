...
def main() -> None:
    ...
    parser.add_argument("--evaluation-mode", choices=["replay", "stochastic_ips"], default="replay")
    ...
    sensitive_cols = ["scenario", "algo", "sensitive_impressions", "sensitive_ctr", "ips_ctr_sensitive", "snips_ctr_sensitive", "ips_regret_sens"]
